<?php
// Student dashboard header file - includes navigation with My Submissions and Logout
...
<head>
    ...
    <title>My Submissions - SAC Cyberian Repository</title>
                ...
                <div class="flex justify-between items-center h-14 sm:h-16 md:h-16">
                    ...
                    <div class="hidden md:flex items-center space-x-4 lg:space-x-8">
                        ...
                        <?php if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] === true): ?>
                            <!-- Show non-clickable username + icon and Logout button -->
                            <div class="flex items-center space-x-3">
                                <div class="flex items-center text-white text-sm lg:text-base whitespace-nowrap">
